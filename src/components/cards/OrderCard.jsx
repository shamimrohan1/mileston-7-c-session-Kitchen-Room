...
const OrderCard = ({order, handleOrder}) => {
  // Static data (mock order)
    ...
    // const handleOrder = (order) => {                   (ata orderContainer ar vitore kaj korbo akhan theke niye)
    //     console.log(order);
    // };
...
//   };
  ...
  return (
    <div onClick={() => handleOrder(order)} className="p-5 rounded-xl shadow-xl relative space-y-3">
      ...
      {/* Table Number Badge */}
      <div className="absolute right-2 top-2 w-10 h-10 flex justify-center items-center bg-amber-500 rounded-full 
